...
def formatting_data():
    ...
    df = pd.read_csv('/data/hpcdata/users/kenzi22/data/VALUE/precip.txt')
    ...
    df4 = pd.read_csv('/data/hpcdata/users/kenzi22/data/VALUE/stations.txt')
    ...
    df7.to_csv('/data/hpcdata/users/kenzi22/data/VALUE/value_rsamp.csv')
...
def all_gauge_data(minyear, maxyear, threshold=None):
    ...
    filepath = '/data/hpcdata/users/kenzi22/data/VALUE/value_rsamp.csv'
