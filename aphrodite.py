...
def collect_APHRO(location, minyear, maxyear):
    ...
    aphro_ds = xr.open_dataset("/data/hpcdata/users/kenzi22/data/APHRODITE/aphrodite_indus_1951_2016.nc")
...
def merge_og_files():
    ...
    for f in tqdm(glob.glob(
            '/data/hpcdata/users/kenzi22/data/APHRODITE/APHRO_MA_025deg_V1101.1951-2007.gz/*.nc')):
    ...
    print('2007-2016')
    for f in tqdm(
            glob.glob('/data/hpcdata/users/kenzi22/data/APHRODITE/APHRO_MA_025deg_V1101_EXR1/*.nc')):
        ds = xr.open_dataset(f)
    ...
    ds_merged.to_netcdf("/data/hpcdata/users/kenzi22/data/APHRODITE/aphrodite_indus_1951_2016.nc")
