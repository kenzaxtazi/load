...
def collect_CRU(location, minyear, maxyear):
    ...
    cru_ds = xr.open_dataset(pwd + "data/CRU/interpolated_cru_1901-2019.nc")
...
def download():
    ...
    ds = xr.open_dataset(pwd + "data/CRU/cru_ts4.04.1901.2019.pre.dat.nc")
    ds_cropped = ds.sel(
    ...
    interp_ds.to_netcdf(pwd + "data/CRU/interpolated_cru_1901-2019.nc")
